...
const pillarsSecondRow = [
  ...
  {
    slug: "atencion-psicologica",
    title: "Atención Psicológica",
    desc: "Equipo de psicólogos especializados para atención profesional y personalizada.",
    icon: (
      <svg className="w-10 h-10 text-[#00A4CF]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    desc: "Asesoría en Legal, Fiscal, Financiera, Nutricional y Liderazgo.",
    icon: (
      <svg className="w-10 h-10 text-[#00A4CF]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
      </svg>
    ...
    <> 
      <div className="flex flex-col w-full font-sans">
          <section className="flex flex-col md:flex-row h-auto md:h-[350px] w-full">
            <div className="w-full md:w-1/2 bg-[#56cbf1] flex flex-col justify-center px-6 sm:px-8 md:px-20 py-12">
