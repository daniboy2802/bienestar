      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <div className="flex items-center gap-4 mb-3">
            <a 
              href="https://www.facebook.com/profile.php?id=61584020998454&mibextid=rS40aB7S9Ucbxw6v" 
              target="_blank" 
            ...
            <a 
              href="https://www.instagram.com/bienestarpae?igsh=MTB2d2Zsa2tuOGhmcg==" 
              target="_blank" 
              rel="noopener noreferrer"
              className="hover:opacity-80 transition"
            >
          ...
          <div className="space-y-3">
            <p className="flex items-center gap-3">
              <span>✉️</span> 
              <a href="mailto:contacto@bienestarpae.com" className="hover:underline">
                contacto@bienestarpae.com
              </a>
            </p>
            <p className="flex items-center gap-3">
              <span>📞</span> 
              <a href="tel:+525537845715" className="hover:underline">
                5537845715
              </a>
            </p>
          </div>
